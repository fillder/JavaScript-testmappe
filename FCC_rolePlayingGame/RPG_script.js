...
function goFight() {
   ...
   monsterName.innerText = capitalizeFirstLetter(monsters[fighting].name);
...
function attack() {
   ...
   // Bruker verdien til en variabel for å hente riktig indeksert våpennavn
   text.innerText += " You attack it with your " + weapons[currentWeaponIndex].name + ".";
   health -= getMonsterAttackValue(monsters[fighting].level);
   // Legger til XP som en tilfeldig ektra skade våpenet gjør mot finenden
   if (isMonsterHit()) {
...
/* 1. Her kan vi bruke en ternary operator. Den skrives:
      2. condition ? expressionIfTrue : expressionIfFalse 
      3. Hvis "hit" er over 0, returner "hit", hvis ikke returner 0 
